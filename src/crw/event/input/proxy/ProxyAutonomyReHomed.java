 ...
 * @author jjb
 */
public class ProxyAutonomyReHomed extends InputEvent{
    ...
    public ProxyAutonomyReHomed() {
    }

    public ProxyAutonomyReHomed(UUID relevantOutputEventUuid, UUID missionUuid) {
